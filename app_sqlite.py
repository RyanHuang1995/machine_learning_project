...
def item_sales():
    ...
    #columns in query
    columns = (Train_data.outlet_identifier, Train_data.item_identifier, Train_data.item_type, Train_data.item_visibility_mean_ratio, Train_data.item_MRP, Train_data.item_outlet_sales, item_quantity)
